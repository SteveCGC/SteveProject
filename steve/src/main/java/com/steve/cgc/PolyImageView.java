...
import com.steve.cgc.shapes.PolygonShape;
import com.steve.cgc.shapes.PolygonShapeSpec;
import com.steve.cgc.shapes.RegularPolygonShape;
...
public class PolyImageView extends ImageView {
    ...
    public PolyImageView(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.polyImageViewStyle);
    }


    public PolyImageView(Context context, AttributeSet attrs, int defStyle) {
